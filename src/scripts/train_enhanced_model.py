#!/usr/bin/env python3
"""
Enhanced Transformer Training Script for NASA SMAP/MSL Dataset
Trains the improved transformer model with multivariate anomaly detection capabilities.
"""
...
class EnhancedTrainer:
    ...
    def train(self, train_loader, val_loader, epochs=100, lr=1e-3, patience=15):
        ...
        for epoch in range(epochs):
            ...
            if val_loss < self.best_val_loss:
                ...
                no_improve = 0
                # Save best model
                self.save_checkpoint("best_enhanced_model.pt", epoch, val_loss)
            else:
                no_improve += 1
    ...
    def plot_training_history(self):
        ...
        plt.savefig(
            plots_dir / "enhanced_training_history.png", dpi=300, bbox_inches="tight"
        )
        plt.show()
...
def main():
    ...
    print("Enhanced Transformer Training for NASA SMAP/MSL Dataset")
    print("=" * 60)
    ...
    config = {
        ...
        "patience": 15,
        # Model configuration
        "input_dim": 25,  # NASA has 25 features
        "d_model": 128,
        "nhead": 8,
        "num_layers": 4,
        "dropout": 0.1,
    ...
    # Create model
    print("\nCreating enhanced transformer model...")
    ...
    with open(results_dir / "enhanced_model_results.json", "w") as f:
        json.dump(
            {
    ...
    print(f"\nResults saved to: {results_dir / 'enhanced_model_results.json'}")
